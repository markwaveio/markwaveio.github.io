...
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305134303071.png)
...
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305134325251.png)
...
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305134401205.png)
...
6. AGENTS.md（流程治理与边界）
	...
	- 不写：重复的执行参数
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305134431136.png)
...
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305135724003.png)


#### 一键配置Memory规则Skill，省时省力
这么多配置文件，如果每次都手动一个个更新，违背了使用AI的效率初衷。
我写了一个技能，Memory Sync Protocol
![](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305142423149.png)
...
5. git commit 留可回滚版本
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305134657353.png)

#### 一键配置自动化审核机制，减少人工管理难度
我同步做了自动化自审查机制，如果遇到问题会及时报错提醒你！
![image.png](https://cdn.jsdelivr.net/gh/markcocoYang/Picgo@main/20260305142353648.png)
这个审核技能帮你做两件重要事情！
...
- 命中统计：按最近一周query结果更新锚点次（数据驱动）
遵循以上条件，每周发送周报，当出现数据超出，第一时间报告反馈。
